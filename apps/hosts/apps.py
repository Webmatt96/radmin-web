    ...
    def ready(self):
        ...
        def status_listener():
            try:
                ...
                import json
                r = redis_lib.from_url(settings.REDIS_URL, decode_responses=True, socket_timeout=None)
                pubsub = r.pubsub()
                pubsub.subscribe('radmin:host:status', socket_timeout=None)
                ...
                for message in pubsub.listen():
                    ...
                    try:
                        ...
                        if hostname:
                            ...
                            update_host_status(hostname, online)
